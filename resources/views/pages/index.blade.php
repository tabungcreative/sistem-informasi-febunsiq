			...
			<div class="container-lg">
				<div class="row">
					<div class="col-lg-5 mb-4">
						<img src="{{'/images/img.jpg'}}" class="img" alt="" style="height: 250px; width: 400px" />
					</div>
			...
			<div class="container-fluid p-4" style="background-color: #fff">
				<div class="row d-flex justify-content-center">
					<div class="col-lg-10">
						...
						<div id="carousel-berita" class="carousel slide" data-bs-ride="carousel" style="position: relative">
							<div class="carousel-inner">
								<div class="carousel-item active" data-bs-interval="1000">
									<div class="row mt-5 ms-5 d-flex justify-content-between">
										<div class="col-lg-5">
							...
							<div class="carousel-indicators mt-5" style="position: relative">
								<button type="button" data-bs-target="#carousel-berita" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
								<button type="button" data-bs-target="#carousel-berita" data-bs-slide-to="1" aria-label="Slide 2"></button>
								<button type="button" data-bs-target="#carousel-berita" data-bs-slide-to="2" aria-label="Slide 3"></button>
							</div>
						</div>
					</div>
				</div>
